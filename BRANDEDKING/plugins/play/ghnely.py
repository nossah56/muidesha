...
@app.on_callback_query(filters.regex("^ghnely (\\d+)$"))
...
@app.on_callback_query(filters.regex("^klthom (\\d+)$"))
...
@app.on_callback_query(filters.regex("^bhrawy (\\d+)$"))
...
@app.on_callback_query(filters.regex("^hosny (\\d+)$"))
...
@app.on_callback_query(filters.regex("^ashor (\\d+)$"))
...
@app.on_callback_query(filters.regex("^diab (\\d+)$"))
...
@app.on_callback_query(filters.regex("^hmaqy (\\d+)$"))
...
@app.on_callback_query(filters.regex("^monir (\\d+)$"))
...
@app.on_callback_query(filters.regex("^muslim (\\d+)$"))
...
@app.on_callback_query(filters.regex("^rap (\\d+)$"))
...
@app.on_callback_query(filters.regex("^sasa (\\d+)$"))
...
@app.on_callback_query(filters.regex("^shakosh (\\d+)$"))
...
@app.on_callback_query(filters.regex("^beka (\\d+)$"))
...
@app.on_callback_query(filters.regex("^tekha (\\d+)$"))
...
@app.on_callback_query(filters.regex("^bondq (\\d+)$"))
...
@app.on_callback_query(filters.regex("^madany (\\d+)$"))
